    ...
    <div>
      <Layout>
        <Switch>
          ...
          <PrivateRoute {...props} path="/admin_matches/edit_player/:id" exact component={addEditplayers}/>
          <PrivateRoute {...props} path="/admin_matches/add_player/" exact component={addEditplayers}/>
